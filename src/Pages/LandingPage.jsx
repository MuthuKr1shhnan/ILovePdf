          ...
          <div className='row align-items-center justify-content-center d-lg-flex'>
            ...
            <div className='col-lg-5 col-md-8 col-sm-8 mt-md-5 mt-sm-5 d-flex justify-content-lg-end section__item'>
              ...
              >
                ...
                ></path>
                <path
                  d='m120.958 267.985-7.085.975a3.544 3.544 0 0 1-.482.039 3.082 3.082 0 0 1-1.134-.187c-.894-.328-1.748-.749-2.424-1.608-.676-.859-1.197-1.679-1.942-4.348l7.085-.976c.738 2.67 1.266 3.489 1.942 4.348.676.859 1.53 1.288 2.424 1.608.357.133.707.203 1.134.188.155 0 .311-.016.482-.039ZM106.493 221.536l-7.085.976c-.124.015-.249.031-.373.031l7.085-.976c.124 0 .249-.016.373-.031Z'
                  fill='#E5322D'
                ></path>
                <path
                  d='m106.493 221.536-7.085.976c-.124.015-.249.031-.373.031l7.085-.976c.124 0 .249-.016.373-.031ZM105.319 224.432l-7.085.976c.125-1.147.513-2.108 1.174-2.896l7.085-.976c-.661.789-1.057 1.757-1.174 2.896Z'
                  fill='#E5322D'
                ></path>
                <path
                  fill-rule='evenodd'
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/help/security" className="hover:underline">Security</a></li>
              <li><a href="/help/documentation" className="hover:underline">Tools</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/desktop" className="hover:underline">iLovePDF Desktop</a></li>
              <li><a href="/mobile" className="hover:underline">iLovePDF Mobile</a></li>
              <li><a href="https://developer.ilovepdf.com" target="_blank" className="hover:underline">Developers</a></li>
              <li><a href="/features" className="hover:underline">Features</a></li>
              <li><a href="https://www.iloveimg.com/" target="_blank" className="hover:underline">iloveimg.com</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/help/about" className="hover:underline">Our Story</a></li>
              <li><a href="/blog" className="hover:underline">Blog</a></li>
              <li><a href="/press" className="hover:underline">Press</a></li>
              <li><a href="/help/legal" className="hover:underline">Legal & Privacy</a></li>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-center mt-10 gap-6">
          <div className="flex space-x-4 order-1 md:order-2">
            <a href="https://play.google.com/store/apps/details?id=com.ilovepdf.www" target="_blank">
              <img src="/google_play.svg" alt="Google Play" className="h-10" />
            </a>
            <a href="https://itunes.apple.com/es/app/ilovepdf/id1207332399?mt=8" target="_blank">
              <img src="/app_store.svg" alt="App Store" className="h-10" />
            </a>
          </div>

          <div ref={dropdownRef} className="relative inline-block text-left order-2 md:order-1">
            <button
            ...
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v16a1 1 0 01-1 1H4a1 1 0 01-1-1V4z" /></svg>
              English
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center text-gray-600">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://twitter.com/ilovepdf_com" target="_blank"><i className="fab fa-x-twitter text-xl"></i></a>
            <a href="https://www.facebook.com/ilovepdfcom-238648522858564/" target="_blank"><i className="fab fa-facebook text-xl"></i></a>
            <a href="https://www.linkedin.com/company/ilovepdf/" target="_blank"><i className="fab fa-linkedin text-xl"></i></a>
            <a href="https://www.instagram.com/ilovepdf_official/" target="_blank"><i className="fab fa-instagram text-xl"></i></a>
            <a href="https://www.tiktok.com/@ilovepdf_official" target="_blank"><i className="fab fa-tiktok text-xl"></i></a>
          </div>
        </div>
      </div>
    </footer>
